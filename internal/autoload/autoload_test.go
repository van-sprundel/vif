...
func TestGenerateCreatesAllFiles(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "testhash123", false, nil, true, PlatformCheckFull, nil); err != nil {
...
func TestGenerateAutoloadPHP(t *testing.T) {
	...
	if err := Generate(vendorDir, nil, "abc123", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
	...
	if !strings.Contains(content, "@generated by Composer") {
		t.Error("autoload.php should contain Composer marker")
	}
}
...
func TestGeneratePSR4(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h1", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateNoFiles(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h4", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateClassLoaderEmbedded(t *testing.T) {
	...
	if err := Generate(vendorDir, nil, "h6", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateAutoloadRuntimeWhenSymfonyRuntimePresent(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "runtimehash", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateNoAutoloadRuntimeWithoutSymfonyRuntime(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "noruntimehash", false, nil, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateRootAutoload(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "roothash", false, root, true, PlatformCheckFull, nil); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func BenchmarkGenerate(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		if err := Generate(vendorDir, packages, "benchhash", false, nil, true, PlatformCheckFull, nil); err != nil {
