...
func TestGenerateCreatesAllFiles(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "testhash123", false, nil, true); err != nil {
...
func TestGenerateAutoloadPHP(t *testing.T) {
	...
	if err := Generate(vendorDir, nil, "abc123", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGeneratePSR4(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h1", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGeneratePSR0(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h2", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateFiles(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h3", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateNoFiles(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "h4", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
`), 0o644); err != nil {
	...
	if err := Generate(vendorDir, packages, "h5", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
`), 0o644); err != nil {
	...
	if err := Generate(vendorDir, packages, "h7", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateClassLoaderEmbedded(t *testing.T) {
	...
	if err := Generate(vendorDir, nil, "h6", false, nil, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func TestGenerateRootAutoload(t *testing.T) {
	...
	if err := Generate(vendorDir, packages, "roothash", false, root, true); err != nil {
		t.Fatalf("Generate: %v", err)
	}
...
func BenchmarkGenerate(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		if err := Generate(vendorDir, packages, "benchhash", false, nil, true); err != nil {
